...
export default function ModalVariantEditForm({
  isModalVariant,
  handleModalVariant,
  setVariantList,
  DataFillVariant,
  ...
  useEffect(() => {
    formVariant.setFieldsValue({
      ...DataFillVariant,
      size: DataFillVariant?.size?.split(","),
    });
    setImageUrl(DataFillVariant?.image);
  }, [DataFillVariant]);
  ...
  return (
    <Modal
      closable={false}
      title={<p className="text-center">Edit Variant</p>}
      open={isModalVariant}
      width={700}
      maskClosable={false}
      okText="Edit Variant"
